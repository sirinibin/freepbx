...
function fileAppender (file, layout, logSize, numBackups, compress, timezoneOffset) {
  ...
  numBackups = numBackups === 0 ? 1 : numBackups;
	...
	var writer = {
		stream: openTheStream(file, logSize, numBackups, compress),
		reopen: function() {
			this.stream.end();
			this.stream = openTheStream(file, logSize, numBackups, compress);
		}
	};
...
function openTheStream(file, fileSize, numFiles, compress) {
	var stream;
   if (fileSize) {
