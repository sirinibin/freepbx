...
<html lang="en">
<head>
    <title>Code coverage report for php-parser\bin\formats\parser.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">php-parser\bin\formats\parser.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">php-parser\bin\formats\</a> &#187; parser.js</div>
</div>
<div class="body">
...
module.exports = {
  ...
  ,run: function(data, filename, engine) {
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (test) tests.push(test);
      var writer;
      var ok;
...
<span class="cstat-no" title="statement not covered" >            if (engine.parser.debug) {</span>
...
<span class="cstat-no" title="statement not covered" >            throw new Error('Test should fail to parse : \n&gt;&gt; ' + test.buffer);</span>
          }
        } else {
          try {
            var ast = engine.parseEval(test.buffer);
            <span class="missing-if-branch" title="if path not taken" >I</span>if (engine.parser.debug) {
<span class="cstat-no" title="statement not covered" >              console.log(</span>
                util.inspect(
                  ast, { 
                    showHidden: false, 
...
<span class="cstat-no" title="statement not covered" >            e.source = test.buffer;</span>
